...
{
    private const ERROR_EMPTY = 'This value should not be blank.';
    private const ERROR_TOO_SHORT = 'This value is too short. It should have %s characters or more.';
    private const ERROR_TOO_LONG = 'This value is too long. It should have %s characters or less.';
